...
`;
				...
				children: [
					...
					react_jsx_runtime.jsx("div", {
						...
						children: ticks.map((tick) => {
							const pct = (xAt(tick.i) / CHART_W) * 100;
							const transform = tick.i === 0 ? "none" : tick.i === hours.length - 1 ? "translateX(-100%)" : "translateX(-50%)";
							return react_jsx_runtime.jsx("span", { className: "dsu-chartTick", style: { left: `${pct}%`, transform }, children: tick.label }, tick.i);
						}),
					}),
				],
			});
			...
			return react_jsx_runtime.jsx("div", {
				...
				children: [
					...
					react_jsx_runtime.jsx("div", {
						...
						children: ticks.map((tick) => {
							const pct = (xAt(tick.i) / CHART_W) * 100;
							const transform = tick.i === 0 ? "none" : tick.i === rows.length - 1 ? "translateX(-100%)" : "translateX(-50%)";
							return react_jsx_runtime.jsx("span", { className: "dsu-chartTick", style: { left: `${pct}%`, transform }, children: tick.label }, tick.i);
						}),
					}),
				],
		...
		function Heatmap({ days, t, currency }) {
			...
			cells.forEach((cell, index) => {
				...
				if (month !== lastMonth) {
					lastMonth = month;
					monthTicks.push({ x: HEAT_LEFT + (index / 7) * step + 3, label: t("heatmap.month", { m: String(month) }) });
				}
			});
			const weekdayLabels = [

...
`;
		...
		function Dashboard({ t, data, error, lastUpdated, onRefresh }) {
				...
				children: [
					...
					react_jsx_runtime.jsx(Section, {
						...
						children: react_jsx_runtime.jsx(BreakdownTable, {
							...
							renderRow: (row) => [
								react_jsx_runtime.jsx("td", {
									children: [row.model, row.appliesTo === "default" ? react_jsx_runtime.jsx("span", { className: "dsu-pillTag", children: t("col.default") }) : null],
								}),
							...
							children: [
								react_jsx_runtime.jsx("div", {
									...
									children: [
										...
										react_jsx_runtime.jsx("div", { className: "dsu-toolbar", children: [react_jsx_runtime.jsx("button", { type: "button", className: "dsu-button", disabled: loading, onClick: refresh, children: t("refresh") }), react_jsx_runtime.jsx("button", { type: "button", className: "dsu-close", title: t("widget.close"), onClick: () => setExpanded(false), children: "✕" })] }),
									],
								}),
								react_jsx_runtime.jsx("div", {
									className: "dsu-panelBody",
									children: react_jsx_runtime.jsx(Dashboard, { t, data, error, loading, lastUpdated, onRefresh: refresh }),
								}),
							],
						})
						: null,

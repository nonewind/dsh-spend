...
.mono{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}
		...
		function formatLimitValue(value, unit, currency) {
					...
					react_jsx_runtime.jsx("div", {
						...
						children: plans.map((plan) => {
							...
							if (plan.type === "code") {
								...
								// time replace the locally estimated limit rows.
								...
								const liveWindows = providerUsage !== null
									...
									: [];
								const showLive = liveWindows.length > 0;
										...
										return [
											react_jsx_runtime.jsx("div", {
												...
												children: [
													...
													react_jsx_runtime.jsx("b", { children: `${formatLimitValue(limit.used, limit.unit, currency)} / ${formatLimitValue(limit.limit, limit.unit, currency)} ${unitLabel}` }),
												],
											}, `limit-${index}-row`),
											react_jsx_runtime.jsx("div", {
												className: "dsu-planRow",
												children: [
													...
													react_jsx_runtime.jsx("b", { children: `${t("plan.remainingShort")} ${formatLimitValue(limit.remaining, limit.unit, currency)}` }),
												],
											}, `limit-${index}-bar`),
										];
									})
								...
								const liveBody = [
									react_jsx_runtime.jsx("div", { className: "dsu-planNote", children: `${t("plan.liveSource")} · ${t("lastUpdated")} ${formatTime(providerUsage.fetchedAt)}` }),
									...liveWindows.map((w) => {
